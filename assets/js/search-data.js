...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "places",
          description: "A small gallery of places along the way.",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%71%69%65%6E.%6A%69%6E%67.%30%33@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=WqqU8fQAAAAJ&hl", "_blank");
        },
      },{
      id: 'light-theme',
